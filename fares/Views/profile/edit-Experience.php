...
<div class="theme-layout">
	...
	<div class="responsive-header">
		<div class="mh-head first Sticky">
			...
			<span class="mh-text">
				<a href="index.html" title=""><img src="../../Assets/images/logo2.png" alt=""></a>
			</span>
										...
										<?php if ($edit_experience): ?>
											<form method="post">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="edit_work_at" name="work_at" value="<?php echo htmlspecialchars($edit_experience->workAt); ?>" required>
												</div>
												<div class="form-group">
													<label for="edit_from_year">From Year</label>
													<input type="number" class="form-control" id="edit_from_year" name="from_year" min="1900" max="2099" value="<?php echo htmlspecialchars($edit_experience->fromYear); ?>" required>
												</div>
												<div class="form-group">
													<label for="edit_to_year">To Year</label>
													<input type="number" class="form-control" id="edit_to_year" name="to_year" min="1900" max="2099" value="<?php echo htmlspecialchars($edit_experience->toYear); ?>">
												</div>
												<div class="form-group">
													<label for="edit_description">Description</label>
													<textarea class="form-control" id="edit_description" name="description" rows="3"><?php echo htmlspecialchars($edit_experience->description); ?></textarea>
												</div>
												...
												<div class="experience-item card mb-3">
													<div class="card-body">
														<div class="d-flex justify-content-between align-items-start">
															<div>
																<h6 class="card-title mb-1"><?php echo htmlspecialchars($experience->workAt); ?></h6>
																<p class="card-text text-muted">
																	<?php echo htmlspecialchars($experience->fromYear); ?> - 
																	<?php echo !empty($experience->toYear) ? htmlspecialchars($experience->toYear) : 'Present'; ?>
																</p>
																<?php if (!empty($experience->description)): ?>
																	<p class="card-text"><?php echo nl2br(htmlspecialchars($experience->description)); ?></p>
																<?php endif; ?>
															</div>
															<div>
