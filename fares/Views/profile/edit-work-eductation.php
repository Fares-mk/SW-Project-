										...
										<?php if ($edit_education): ?>
											<form method="post">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="edit_studying_at" name="studying_at" value="<?php echo htmlspecialchars($edit_education->studyingAt); ?>" required>
												</div>
												<div class="form-group">
													<label for="edit_from_year">From Year</label>
													<input type="number" class="form-control" id="edit_from_year" name="from_year" min="1900" max="2099" value="<?php echo htmlspecialchars($edit_education->fromYear); ?>" required>
												</div>
												<div class="form-group">
													<label for="edit_to_year">To Year</label>
													<input type="number" class="form-control" id="edit_to_year" name="to_year" min="1900" max="2099" value="<?php echo htmlspecialchars($edit_education->toYear); ?>">
												</div>
												<div class="form-group">
													<label for="edit_description">Description</label>
													<textarea class="form-control" id="edit_description" name="description" rows="3"><?php echo htmlspecialchars($edit_education->description); ?></textarea>
												</div>
												...
												<div class="education-item card mb-3">
													<div class="card-body">
														<div class="d-flex justify-content-between align-items-start">
															<div>
																<h6 class="card-title mb-1"><?php echo htmlspecialchars($edu->studyingAt); ?></h6>
																<p class="card-text text-muted mb-1">
																	<?php echo htmlspecialchars($edu->fromYear); ?> - 
																	<?php echo !empty($edu->toYear) ? htmlspecialchars($edu->toYear) : 'Present'; ?>
																</p>
