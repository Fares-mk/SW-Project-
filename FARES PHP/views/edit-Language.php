...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_language'])) {
        ...
        $languageController->addLanguage($name);
    } elseif (isset($_POST['update_language'])) {
        $id = $_POST['language_id'];
        $name = $_POST['language_name'];
        $languageController->updateLanguage($id, $name);
...
// Get all language entries for display
								...
								<div class="col-lg-6">
									<div class="central-meta">
										<div class="editing-interest">
											...
											<div class="language-list mt-4">
												<h5>Your Languages</h5>
												<?php if (empty($languages)): ?>
													<p class="text-muted">No languages yet. Add your first language above.</p>
												<?php else: ?>
													...
													<div class="language-item card mb-3">
														<div class="card-body">
															<div class="d-flex justify-content-between align-items-center">
																<div>
																	<h6 class="card-title mb-1"><?php echo ($language['language_name']); ?></h6>
																</div>
																<form method="post" class="delete-form">
																	<input type="hidden" name="language_id" value="<?php echo $language['id']; ?>">
																	<button type="submit" name="delete_language" class="btn btn-link text-danger" onclick="return confirm('Are you sure you want to delete this language?')">
