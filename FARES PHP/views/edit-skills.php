...
// Get all skill entries for display
$skills = $skillController->getAll();

// Debug: Check if skills were retrieved
if ($skills === null) {
    echo "<div class='alert alert-warning'>Error retrieving skills. Please try again later.</div>";
    error_log("Failed to retrieve skills");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="theme-layout">
	...
	<div class="responsive-header">
		<div class="mh-head first Sticky">
			...
			<span class="mh-text">
				<a href="profile.php" title=""><img src="../images/logo2.png" alt=""></a>
			</span>
								...
								<div class="col-lg-6">
									<div class="central-meta">
										<div class="editing-interest">
											<h5 class="f-title"><i class="ti-clipboard"></i>Skills</h5>
											<form method="post">
											...
											<div class="skill-list mt-4">
												<h5>Your Skills</h5>
												<?php if (empty($skills)): ?>
													<p class="text-muted">No skills yet. Add your first skill above.</p>
												<?php else: ?>
													...
													<div class="skill-item card mb-3">
														<div class="card-body">
															<div class="d-flex justify-content-between align-items-center">
																<div>
																	<h6 class="card-title mb-1"><?php echo ($skill['skill_name']); ?></h6>
																</div>
																<form method="post" class="delete-form">
																	<input type="hidden" name="skill_id" value="<?php echo $skill['id']; ?>">
																	<button type="submit" name="delete_skill" class="btn btn-link text-danger" onclick="return confirm('Are you sure you want to delete this skill?')">
