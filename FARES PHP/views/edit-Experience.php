...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_experience'])) {
        ...
        $experienceController->addExperience($work_at, $from_year, $to_year, $description);
...
$experiences = $experienceController->getAll();
error_log("Retrieved " . count($experiences) . " experiences");
?>
<!DOCTYPE html>
<html lang="en">
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="editing-interest">
										<h5 class="f-title"><i class="ti-briefcase"></i>Experience</h5>
										<form method="post">
											<div class="form-group">
												<label>Work At:</label>
												<input type="text" name="work_at" class="form-control" required>
											</div>
											<div class="form-group">
												<label>From Year:</label>
												<input type="date" name="from_year" class="form-control" required>
											</div>
											<div class="form-group">
												<label>To Year:</label>
												<input type="date" name="to_year" class="form-control">
											</div>
											<div class="form-group">
										...
										<div class="experience-list mt-4">
											...
											<?php if (empty($experiences)): ?>
												<p class="text-muted">No experience entries yet. Add your first experience above.</p>
											<?php else: ?>
												...
												<div class="experience-item card mb-3">
													<div class="card-body">
														<div class="d-flex justify-content-between align-items-start">
															<div>
																<h6 class="card-title mb-1"><?php echo htmlspecialchars($experience['work_at']); ?></h6>
																<p class="card-text text-muted small">
																	<?php echo htmlspecialchars($experience['from_year']); ?> - 
																	<?php echo $experience['to_year'] ? htmlspecialchars($experience['to_year']) : 'Present'; ?>
																</p>
															...
															<form method="post" class="delete-form">
																...
																<button type="submit" name="delete_experience" class="btn btn-link text-danger" onclick="return confirm('Are you sure you want to delete this experience?')">
